      ...
      >
        ...
        <Typography sx={{ fontSize: 30, textAlign: "center", p:2 }}>
          <Paper sx={{fontSize: 20,width: ['100%', '100%', 500, 700],height: ['100%'],p: 2,bgcolor: '#eeeeee',}}>
            <Typography sx={{fontSize:30, fontWeight: '900', color:'#000000'}}>Accelerating Recovery: Blood Flow Restriction Training in Post-Operative ACL Reconstruction Surgery - A Physical Therapy Breakthrough
            </Typography>
